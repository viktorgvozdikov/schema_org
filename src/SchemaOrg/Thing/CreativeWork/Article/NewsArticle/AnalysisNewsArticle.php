...
use ModuleBZ\SchemaOrg\Traits\Thing\CreativeWork\Article\NewsArticle\TAnalysisNewsArticle;


class AnalysisNewsArticle extends Thing{
	use TThing;
	use TCreativeWork;
	use TArticle;
	use TNewsArticle;
	use TAnalysisNewsArticle;
}