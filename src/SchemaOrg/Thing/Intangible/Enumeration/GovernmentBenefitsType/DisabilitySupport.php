...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\GovernmentBenefitsType\TDisabilitySupport;


class DisabilitySupport extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TGovernmentBenefitsType;
	use TDisabilitySupport;
}