...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\GovernmentBenefitsType\TParentalSupport;


class ParentalSupport extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TGovernmentBenefitsType;
	use TParentalSupport;
}