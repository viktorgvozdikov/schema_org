...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\PhysicalActivityCategory\TAerobicActivity;


class AerobicActivity extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TPhysicalActivityCategory;
	use TAerobicActivity;
}