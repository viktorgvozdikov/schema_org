...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\PhysicalActivityCategory\TStrengthTraining;


class StrengthTraining extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TPhysicalActivityCategory;
	use TStrengthTraining;
}