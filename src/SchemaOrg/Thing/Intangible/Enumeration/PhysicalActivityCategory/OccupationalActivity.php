...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\PhysicalActivityCategory\TOccupationalActivity;


class OccupationalActivity extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TPhysicalActivityCategory;
	use TOccupationalActivity;
}