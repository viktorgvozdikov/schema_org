...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MerchantReturnEnumeration\TMerchantReturnUnlimitedWindow;


class MerchantReturnUnlimitedWindow extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMerchantReturnEnumeration;
	use TMerchantReturnUnlimitedWindow;
}