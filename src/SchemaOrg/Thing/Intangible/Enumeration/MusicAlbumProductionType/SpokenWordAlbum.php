...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MusicAlbumProductionType\TSpokenWordAlbum;


class SpokenWordAlbum extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMusicAlbumProductionType;
	use TSpokenWordAlbum;
}