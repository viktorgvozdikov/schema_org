...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MusicAlbumProductionType\TSoundtrackAlbum;


class SoundtrackAlbum extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMusicAlbumProductionType;
	use TSoundtrackAlbum;
}