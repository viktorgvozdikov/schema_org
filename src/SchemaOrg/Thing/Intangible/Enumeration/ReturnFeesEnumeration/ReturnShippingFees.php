...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\ReturnFeesEnumeration\TReturnShippingFees;


class ReturnShippingFees extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TReturnFeesEnumeration;
	use TReturnShippingFees;
}