...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\ActionStatusType\TActiveActionStatus;


class ActiveActionStatus extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TActionStatusType;
	use TActiveActionStatus;
}