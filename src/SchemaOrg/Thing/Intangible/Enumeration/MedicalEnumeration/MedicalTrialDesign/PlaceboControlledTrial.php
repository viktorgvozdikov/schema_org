...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MedicalEnumeration\MedicalTrialDesign\TPlaceboControlledTrial;


class PlaceboControlledTrial extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMedicalEnumeration;
	use TMedicalTrialDesign;
	use TPlaceboControlledTrial;
}