...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MedicalEnumeration\MedicalTrialDesign\TInternationalTrial;


class InternationalTrial extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMedicalEnumeration;
	use TMedicalTrialDesign;
	use TInternationalTrial;
}