...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\MedicalEnumeration\MedicalTrialDesign\TDoubleBlindedTrial;


class DoubleBlindedTrial extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TMedicalEnumeration;
	use TMedicalTrialDesign;
	use TDoubleBlindedTrial;
}