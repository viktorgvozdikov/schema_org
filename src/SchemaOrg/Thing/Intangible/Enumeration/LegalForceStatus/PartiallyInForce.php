...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\LegalForceStatus\TPartiallyInForce;


class PartiallyInForce extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TLegalForceStatus;
	use TPartiallyInForce;
}