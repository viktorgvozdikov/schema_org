...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\LegalValueLevel\TUnofficialLegalValue;


class UnofficialLegalValue extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TLegalValueLevel;
	use TUnofficialLegalValue;
}