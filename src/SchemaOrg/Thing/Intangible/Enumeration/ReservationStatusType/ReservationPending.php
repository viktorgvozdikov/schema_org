...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\ReservationStatusType\TReservationPending;


class ReservationPending extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TReservationStatusType;
	use TReservationPending;
}