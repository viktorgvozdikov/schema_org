...
use ModuleBZ\SchemaOrg\Traits\Thing\Intangible\Enumeration\ItemAvailability\TLimitedAvailability;


class LimitedAvailability extends Thing{
	use TThing;
	use TIntangible;
	use TEnumeration;
	use TItemAvailability;
	use TLimitedAvailability;
}