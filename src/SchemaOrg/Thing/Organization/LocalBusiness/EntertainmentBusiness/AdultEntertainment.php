...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\EntertainmentBusiness\TAdultEntertainment;


class AdultEntertainment extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TEntertainmentBusiness;
	use TAdultEntertainment;
}