...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\SportsActivityLocation\TPublicSwimmingPool;


class PublicSwimmingPool extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TSportsActivityLocation;
	use TPublicSwimmingPool;
}