...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\Store\TOfficeEquipmentStore;


class OfficeEquipmentStore extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TStore;
	use TOfficeEquipmentStore;
}