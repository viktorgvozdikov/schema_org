...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\FoodEstablishment\TFastFoodRestaurant;


class FastFoodRestaurant extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TFoodEstablishment;
	use TFastFoodRestaurant;
}