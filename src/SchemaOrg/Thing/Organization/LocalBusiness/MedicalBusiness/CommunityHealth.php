...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\MedicalBusiness\TCommunityHealth;


class CommunityHealth extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TMedicalBusiness;
	use TCommunityHealth;
}