...
use ModuleBZ\SchemaOrg\Traits\Thing\Organization\LocalBusiness\MedicalBusiness\TOtolaryngologic;


class Otolaryngologic extends Thing{
	use TThing;
	use TOrganization;
	use TLocalBusiness;
	use TMedicalBusiness;
	use TOtolaryngologic;
}