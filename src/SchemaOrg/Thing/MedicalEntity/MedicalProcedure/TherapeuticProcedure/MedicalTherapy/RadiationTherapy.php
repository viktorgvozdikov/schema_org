...
use ModuleBZ\SchemaOrg\Traits\Thing\MedicalEntity\MedicalProcedure\TherapeuticProcedure\MedicalTherapy\TRadiationTherapy;


class RadiationTherapy extends Thing{
	use TThing;
	use TMedicalEntity;
	use TMedicalProcedure;
	use TTherapeuticProcedure;
	use TMedicalTherapy;
	use TRadiationTherapy;
}