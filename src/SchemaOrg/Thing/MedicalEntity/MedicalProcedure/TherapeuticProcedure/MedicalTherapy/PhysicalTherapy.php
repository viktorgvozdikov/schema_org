...
use ModuleBZ\SchemaOrg\Traits\Thing\MedicalEntity\MedicalProcedure\TherapeuticProcedure\MedicalTherapy\TPhysicalTherapy;


class PhysicalTherapy extends Thing{
	use TThing;
	use TMedicalEntity;
	use TMedicalProcedure;
	use TTherapeuticProcedure;
	use TMedicalTherapy;
	use TPhysicalTherapy;
}