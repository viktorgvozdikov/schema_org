...
use ModuleBZ\SchemaOrg\Traits\Thing\MedicalEntity\MedicalIntangible\DoseSchedule\TRecommendedDoseSchedule;


class RecommendedDoseSchedule extends Thing{
	use TThing;
	use TMedicalEntity;
	use TMedicalIntangible;
	use TDoseSchedule;
	use TRecommendedDoseSchedule;
}